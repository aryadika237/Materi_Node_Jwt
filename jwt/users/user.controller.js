...
router.post('/autheticate', authenticateSchema, autheticate);
...
function register(req, res, next) {
    userService.create(req.body)
        .then(() => res.json({ message: 'Registrasi Berhasil' }))
        .catch(next)
}
...
function _delete(req, res, next) {
    userService.update(req.params.id)
        .then(() => res.json({ message: 'User sukses dihapus' }))
        .catch(next)
}
// const express = require('express');
// const router = express.Router();
...
// function upadateSchema(req, res, next) {
//     const schema = Joi.object({
//         firstName: Joi.string().empty(''),
//         lastName: Joi.string().empty(''),
//         username: Joi.string().empty(''),
